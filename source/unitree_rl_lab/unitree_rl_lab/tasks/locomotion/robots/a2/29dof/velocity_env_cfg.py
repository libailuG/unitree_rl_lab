...
from unitree_rl_lab.assets.robots.taixi import TAIXI_A2_CFG as ROBOT_CFG
# from unitree_rl_lab.assets.robots.taixi import TAIXI_A2_FIX_BASE_CFG as ROBOT_CFG
...
class EventCfg:
    ...
    add_base_mass = EventTerm(
        ...
        params={
            ...
            "mass_distribution_params": (-0.01, 1.0),
            "operation": "add",
        },
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # base_ang_vel = ObsTerm(func=mdp.base_ang_vel, scale=0.2, noise=Unoise(n_min=0.0, n_max=0.0))
        # projected_gravity = ObsTerm(func=mdp.projected_gravity, noise=Unoise(n_min=-0.0, n_max=0.0))
        # velocity_commands = ObsTerm(func=mdp.generated_commands, params={"command_name": "base_velocity"})
        # joint_pos_rel = ObsTerm(func=mdp.joint_pos_rel, noise=Unoise(n_min=-0.00, n_max=0.00))
        # joint_vel_rel = ObsTerm(func=mdp.joint_vel_rel, scale=0.05, noise=Unoise(n_min=0.0, n_max=0.0))
